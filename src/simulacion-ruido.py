...
PATH_ARCHIVOS = join(dirname(dirname(abspath(__file__))), "txt")
...
archivo_entrada = open(join(PATH_ARCHIVOS, ARCHIVO_ENTRADA), 'r')
...
archivo_salida = open(join(PATH_ARCHIVOS, ARCHIVO_SALIDA), 'w')
